$(function(){
    ...
    '<li class="active-link">'+
           '<a href="pdf.html" ><i class="fa fa-desktop "></i>个人简历 </a>'+
           '</li>'+
    ...
    '<ul class="child-ul">'+
       ...
       '</li>'+
       '<li class="active-link">'+
           '<a href="feign.html" ><i class="fa fa-desktop "></i>创建服务消费者feign </a>'+
       '</li>'+
       '<li class="active-link">'+
   ...
   '<ul  class="child-ul">'+
   '<li class="active-link">'+
           '<a href="jvm.html" ><i class="fa fa-desktop "></i>JVM概念和结构 </a>'+
       '</li>'+
   '</ul>'+
'</ul>';
